...
urlpatterns = [
    ...
    path('passwordreset/',auth_views.PasswordResetView.as_view(template_name='app/password_reset.html',form_class=MyPasswordResetForm),name='passwordreset'),
    ...
    path('coats/<slug:data>', views.coats, name='coatsdata'),
